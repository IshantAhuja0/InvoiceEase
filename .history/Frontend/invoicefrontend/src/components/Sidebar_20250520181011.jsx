...
export default function Sidebar({ isOpen, sidebarRef }) {
  ...
  return (
    <aside
      ref={sidebarRef}
      className={`w-48 fixed top-16 left-0 z-40 lg:w-60 h-[calc(100vh-4rem)] bg-blue-950 text-white transition-transform duration-300 ease-in-out sm:translate-x-0 ${
