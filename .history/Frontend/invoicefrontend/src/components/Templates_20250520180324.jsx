...
>
  ...
  {/* Enlarged overlay */}
  <div className="absolute inset-0 flex items-center justify-center transition-all duration-300 group-hover:scale-150 group-hover:z-50 group-hover:opacity-100 opacity-0 scale-100 bg-black/60 rounded-2xl">
