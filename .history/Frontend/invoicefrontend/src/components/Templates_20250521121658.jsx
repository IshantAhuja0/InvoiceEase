...
>
  ...
  <div className="p-2 flex flex-col justify-between h-30">
    ...
    <button className="bg-blue-950 text-white px-4 py-2 rounded-md hover:bg-blue-900 transition mt-auto flex items-center gap-0.5 justify-center">
      Create Invoice
      <IoMdAddCircle  className="font-bold w-24"/>
    </button>
  </div>
</motion.div>
