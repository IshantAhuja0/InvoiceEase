  ...
  return (
    ...
    >
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <input onChange={handleChangeFirmInfo} value={firmInfo.firmName} name="firmName" className="input flex-1 p-2  bg-blue-100 rounded-md" required placeholder="Your Business" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">Address:</label>
              <input onChange={handleChangeFirmInfo} value={firmInfo.firmAddress} name="firmAddress" className="input flex-1 p-2  bg-blue-100 rounded-md" required placeholder="123 Street, City" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">GSTIN / Tax ID:</label>
              <input onChange={handleChangeFirmInfo} value={firmInfo.firmGstin} name="firmGstin" className="input flex-1 p-2  bg-blue-100 rounded-md" placeholder="GSTIN / PAN" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">Email:</label>
              <input onChange={handleChangeFirmInfo} value={firmInfo.firmEmail} name="firmEmail" className="input flex-1 p-2  bg-blue-100 rounded-md" type="email" required placeholder="email@firm.com" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">Phone:</label>
              <input onChange={handleChangeFirmInfo} value={firmInfo.firmPhone} name="firmPhone" className="input flex-1 p-2  bg-blue-100 rounded-md" type="tel" required placeholder="+91-9876543210" />
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <input onChange={handleChangeCustomerInfo} value={customerInfo.customerName} name="customerName" className="input flex-1 p-2 bg-blue-100 rounded-md" required placeholder="Client Name" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">Company:</label>
              <input onChange={handleChangeCustomerInfo} value={customerInfo.customerFirm} name="customerFirm" className="input flex-1 p-2  bg-blue-100 rounded-md" placeholder="Client Company" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">Address:</label>
              <input onChange={handleChangeCustomerInfo} value={customerInfo.customerAddress} name="customerAddress" className="input flex-1 p-2  bg-blue-100 rounded-md" required placeholder="Client Address" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">Email:</label>
              <input onChange={handleChangeCustomerInfo} value={customerInfo.customerEmail} name="customerEmail" className="input flex-1 p-2   bg-blue-100 rounded-md" type="email" placeholder="client@email.com" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">Phone:</label>
              <input onChange={handleChangeCustomerInfo} value={customerInfo.customerPhone} name="customerPhone" className="input flex-1 p-2  bg-blue-100 rounded-md" type="tel" placeholder="+91-9123456789" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid sm:grid-cols-3 gap-6 mb-10">
        <input className="input p-2  bg-blue-100 rounded-md" placeholder="Invoice Number" required />
        <input className="input p-2  bg-blue-100 rounded-md" type="date" placeholder="Invoice Date" required />
        <input className="input p-2  bg-blue-100 rounded-md" type="date" placeholder="Due Date" required />
      </div>
