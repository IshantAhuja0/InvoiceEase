...
export default function Sidebar({ isOpen, sidebarRef }) {
  const menuItems = [
    {
      ...
      {
        name: "Sign in",
        svgPath1: "M1 8h11m0 0L8 4m4 4-4 4m4-11h3a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-3",
        svgPath2:
        "M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z",
        path:'signin'
      },
  ...
  return (
    <aside
      ref={sidebarRef}
      className={`w-46 fixed top-16 left-0 z-40 lg:w-60 h-[calc(100vh-4rem)] bg-blue-950 text-white transition-transform duration-300 ease-in-out sm:translate-x-0 ${
...
<li key={idx} className="hover:bg-gray-100 hover:rounded-md">
  <NavLink
    to={item.path}
    className="flex items-center p-2 rounded-lg text-white hover:text-black transition-colors duration-300"
  >
    <svg
