        ...
        {templates.map((template) => (
          ...
          >
            ...
            <div className="p-2 flex flex-col justify-between h-30">
              ...
              <button onClick={()=>navigateFrom} className="bg-blue-950 text-white px-4 py-2 rounded-md hover:bg-blue-900 transition mt-auto flex items-center gap-1 justify-center">
                Create Invoice
