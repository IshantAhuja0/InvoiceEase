...
<motion.div
  ...
  className="absolute top-1/2 left-1/2 w-[400px] h-[500px] z-50 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none rounded-xl overflow-hidden border-4 border-white shadow-2xl bg-white"
>
  <img
    src={template.src}
