  ...
  return (
    ...
    >
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <input className="input flex-1 p-2  bg-blue-100 rounded-xl" required placeholder="Your Business" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">Address:</label>
              <input className="input flex-1 p-2  bg-blue-100 rounded-xl" required placeholder="123 Street, City" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">GSTIN / Tax ID:</label>
              <input className="input flex-1 p-2  bg-blue-100 rounded-xl" placeholder="GSTIN / PAN" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">Email:</label>
              <input className="input flex-1 p-2  bg-blue-100 rounded-xl" type="email" required placeholder="email@firm.com" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">Phone:</label>
              <input className="input flex-1 p-2  bg-blue-100 rounded-xl" type="tel" required placeholder="+91-9876543210" />
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              <input className="input flex-1 p-2  bg-blue-100 rounded-xl" placeholder="Client Company" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">Address:</label>
              <input className="input flex-1 p-2  bg-blue-100 rounded-xl" required placeholder="Client Address" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">Email:</label>
              <input className="input flex-1 p-2   bg-blue-100 rounded-xl" type="email" placeholder="client@email.com" />
            </div>
            <div className="flex items-center">
              <label className="w-40 font-medium">Phone:</label>
              <input className="input flex-1 p-2  bg-blue-100 rounded-xl" type="tel" placeholder="+91-9123456789" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid sm:grid-cols-3 gap-6 mb-10">
        <input className="input p-2  bg-blue-100 rounded-xl" placeholder="Invoice Number" required />
        <input className="input p-2  bg-blue-100 rounded-xl" type="date" placeholder="Invoice Date" required />
        <input className="input p-2  bg-blue-100 rounded-xl" type="date" placeholder="Due Date" required />
      </div>
