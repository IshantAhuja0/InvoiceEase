  ...
  return (
    ...
    >
      ...
      <div className="grid sm:grid-cols-3 gap-6 mb-10">
        <input className="input p-2" placeholder="Invoice Number" required />
        <input className="input p-2" type="date" placeholder="Invoice Date" required />
        <input className="input p-2" type="date" placeholder="Due Date" required />
      </div>
