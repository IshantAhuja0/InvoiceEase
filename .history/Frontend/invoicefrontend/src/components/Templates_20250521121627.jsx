...
>
  ...
  <div className="p-2 flex flex-col justify-between h-30">
    ...
    <button className="bg-blue-950 text-white px-4 py-2 rounded-md hover:bg-blue-900 transition mt-auto flex items-center gap-2 justify-center">
      Create Invoice
      <IoMdAddCircle  className="font-bold w-2.5"/>
    </button>
  </div>
</motion.div>
